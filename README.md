# Prova Frontend SÊNIOR SD - Configuração

Bem-vindo à prova prática para a vaga de programador Frontend React/React Native no SENAI Soluções Digitais. Ficamos felizes no seu interesse pela vaga e desejamos uma ótima prova.  
